...
class ServiceClient:
    ...
    def _get_service_call_metadata(self):
        ...
        signature = bytes(
            self.sdk.web3.eth.account.signHash(
                ...
                self.sdk.account.signer_private_key).signature)
        metadata = [
    ...
    def open_channel(self, amount, expiration):
        receipt = self.sdk.mpe_contract.open_channel(self.sdk.account, self,
                                                     amount, expiration)
    ...
    def _get_newly_opened_channel(self, receipt):
        open_channels = self.sdk.mpe_contract.get_past_open_channels(
            self.sdk.account, self, receipt["blockNumber"],
            receipt["blockNumber"])
