...
key to sign the Owner Certificate.""")
    parser.add_argument(
        "--key", help="Which endorsement scheme to use (1 or 2)", type=auto_int)
...
if __name__ == '__main__':
    ...
    publicKey = getDeployedSecretV2(dongle, bytearray.fromhex(
    ...
    if args.certificate != None:
        ...
        apdu = bytearray(
            [0xe0, 0xC2, 0x00, 0x00, len(certificate)]) + certificate
        dongle.exchange(apdu)
