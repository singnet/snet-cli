...
class OrganizationCommand(BlockchainCommand):
    ...
    def add_group(self):
        ...
        payment_storage_client = PaymentStorageClient(
            self.args.payment_channel_connection_timeout, self.args.payment_channel_request_timeout, self.args.endpoints)
    ...
    def create(self):
        ...
        ipfs_metatdata_uri = publish_file_in_ipfs(
            self._get_ipfs_client(), metadata_file)
    ...
    def update_metadata(self):
        ...
        ipfs_metatdata_uri = publish_file_in_ipfs(
            self._get_ipfs_client(), metadata_file)
        params = [type_converter("bytes32")(
            org_id), ipfs_metatdata_uri, members]
        self._printout("Creating transaction to create organization name={} id={}\n".format(
            self.args.org_name, org_id))
        self.transact_contract_command(
