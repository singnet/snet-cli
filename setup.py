...
def install_and_compile_proto():
    ...
    proto_dir = Path(__file__).absolute().parent.joinpath("snet_cli",
                                                          "resources",
                                                          "proto")
    dest_dir = Path(snet_cli.__file__).absolute().parent.joinpath("resources",
                                                                  "proto")
...
setup(
    ...
    install_requires=[
        ...
        'eth-hash>=0.2.0',  # eth-hash v0.2.0 requires pycryptodome>=3.6.6,<4
