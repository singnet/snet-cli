...
snet channel add-for-service testo tests 0.2 -yq
snet channel extend-for-service testo tests 315 -yq
...
snet channel add-for-service testo tests 0.1  -yq
snet channel extend-for-service testo tests 31415  -yq
...
snet channel add-for-service        testo tests 0.01 -yq && exit 1 || echo "fail as expected"
snet channel extend-for-service     testo tests 31477 -yq && exit 1 || echo "fail as expected"

snet channel extend-add-for-service testo tests --amount 0.01 --expiration 314 -yq --channel-id 1
snet channel add-for-service        testo tests 0.01  --channel-id 1 -yq
snet channel extend-for-service     testo tests 31477 -yq --channel-id 1
...
snet channel add-for-service        testo tests2  0.001 -yq && exit 1 || echo "fail as expected"
snet channel extend-for-service     testo tests2 4321 -yq && exit 1 || echo "fail as expected"


snet channel extend-add-for-service testo tests2 --amount 0.001 --expiration 4321 --group-name group1 -yq
snet channel add-for-service        testo tests2  0.001  --group-name group1 -yq
snet channel extend-for-service     testo tests2 4321 --group-name group1 -yq
...
snet channel add-for-service        testo tests2  0.0001  --group-name group2 -yq
snet channel extend-for-service     testo tests2 5643 --group-name group2 -yq
...
snet channel add-for-service        testo tests2  0.00001  --group-name group2 -yq
snet channel extend-for-service     testo tests2 7655 --group-name group2 -yq
