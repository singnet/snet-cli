...
compile_proto("../service_spec1", ".",
              proto_file="ExampleService.proto")
...
# we use MPEChannelCommand._get_channel_state_from_blockchain
# to get channel state from blockchain
...
class PaymentChannelStateService\
    ...
    @staticmethod
    def GetChannelState(request, context):
...
class ProviderControlService\
    ...
    @staticmethod
    def GetListUnclaimed(request, context):
        payments = []
    ...
    @staticmethod
    def GetListInProgress(request, context):
    ...
    @staticmethod
    def StartClaim(request, context):
        remove_already_claimed_payments()
